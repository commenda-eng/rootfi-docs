...
5. Set the App URL to https://integrate.rootfi.dev/wix/callback
6. For the Redirect URL, use [ROOTFI CALLBACK URL](/api-reference/v3/overview/environments#callback-urls)
