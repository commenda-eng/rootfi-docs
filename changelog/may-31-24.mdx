...
Others:
Improved NetSuite Bundle:
Implemented a new authentication method to provide a more stable and reliable connection.
Achieved faster syncs to improve overall performance, ensuring a better user experience.
