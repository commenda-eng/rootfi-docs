...
## The Need for Accounting Integrations
...
If Expenses are unavailable for a particular accounting platform like Xero and Tally, use the [`POST/bills`](https://docs.integrationlabs.co/api-reference/v3/accounting/bills/create-bills) or [`POST/journal_entries`](https://docs.integrationlabs.co/api-reference/v3/accounting/journal-entries/create-journal-entries).
...
Use the [`POST/journal_entries`](https://docs.integrationlabs.co/api-reference/v3/accounting/journal-entries/create-journal-entries) to reflect withdrawals and top-ups for a bank account/prepaid card.
...
1. To log a reimbursement request, use the [`POST/bills`](https://docs.integrationlabs.co/api-reference/v3/accounting/bills/create-bills) to create a bill containing the reimbursement amount.
    - Use the [`POST/contacts`](https://docs.integrationlabs.co/api-reference/v3/accounting/contacts/create-contacts) (filter on type= 'vendor') to create a specific vendor per employee you link to the Bill.
