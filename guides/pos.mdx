...
description: "This guide helps Point-Of-Sale (POS) companies to push merchants' data from their e-commerce or point-of-sale (POS) platform into each merchant's accounting platform."
icon: "tag"
---
...
Integration Labs allows you to push merchants' data from your e-commerce or point-of-sale (POS) platform into each merchant's accounting platform. Your merchants can seamlessly reconcile their e-commerce and accounting data, allowing them to spend more time growing their business.
...
Integration Labs recommends using **journal entries** due to these advantages:
...
**Note**: Store this mapping internally to post Journal Entries accurately.
