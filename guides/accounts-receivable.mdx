...
2. **Items**: Every invoice contains multiple items (either goods or services) that were sold as part of the invoice, each of which credits certain accounts depending on what comprises their cost of goods sold. The **GET/items** lets you fetch all items in the business entity's catalogue.
