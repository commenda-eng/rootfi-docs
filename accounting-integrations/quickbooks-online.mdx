...
4. Add your secure keys to the RootFi dashboard and start pulling data!
...
6. Configure the app to connect to the sandbox environment:
   ...
   3. In the 'Link' box on top, enter the RootFi URI: [ROOTFI CALLBACK URL](/api-reference/v3/overview/environments#callback-urls)
7. Then click Save.
8. Your development keys (client ID and client secret) will be displayed in the 'Keys' section at the top of the page.
9. Copy these keys and simply paste them into the Quickbooks Sandbox integration on the RootFi Platform.
...
6. Go to Production Settings > Keys & Credentials, and configure your app to connect to RootFi:
   1. Go to the Redirect URIs section, and select Add URI.
   2. In the top Link box, enter the RootFi Production URI: Need to add
7. Then click 'Save'.

### Part 3 - Enter your Client ID and Client Secret on the RootFi Dashboard
