...
To start using our Xero integration, you need to first register your Xero application, and then enter your Client ID and Client Secret on the Integration Labs dashboard.
...
4. In the ‘Redirect URIs’ field, enter [ROOTFI CALLBACK URL](/api-reference/v3/overview/environments#callback-urls)
5. Enter the following information in the 'Add a New App' dialogue:
...
## Step 3: Enter Your Client ID and Client Secret on the Integration Labs Dashboard
