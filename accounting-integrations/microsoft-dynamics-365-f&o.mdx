...
2. Select Supported account types: Select Accounts in any organisational directory (Any Azure AD directory - Multi-tenant) and personal Microsoft accounts (e.g. Skype, Xbox). This allows RootFi to access data in Dynamics 365 F&O.
...
### Part 4: Enter Your Client ID and Client Secret on the RootFi Dashboard
