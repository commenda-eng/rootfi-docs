...
<Steps>
  ...
  Search for the **Integration Labs Bundle** or bundle ID **489902** using the Keyword box. ![Untitled](/images/netsuite/Untitled%201.png)
  </Step>
  <Step title="Third Step">
  Select the bundle and click **Install**. ![Untitled](/images/netsuite/Untitled%202.png)
  </Step>
