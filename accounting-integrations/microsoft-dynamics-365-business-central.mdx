...
1. Click on the newly created app, Go to the Overview section, you can see the Application Client ID.
...
<Step title="Get Tenant ID and Env Name from Admin Center" stepNumber="6">
