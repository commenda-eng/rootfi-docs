...
In order to get started using your own credentials for our Square integration, you will need to first register your Square application. After that, you will need to enter your Client ID and Client Secret on the RootFi dashboard.
...
4. In the Production Tab, add the following redirect URL: [ROOTFI CALLBACK URL](/api-reference/v3/overview/environments#callback-urls) and click 'Save'
5. Copy the 'Application ID' (**Client ID**) and 'Application Secret' (**Client Secret**) that you will enter on RootFi’s dashboard in Part 2 below.
