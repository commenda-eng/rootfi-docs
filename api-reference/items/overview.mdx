...
<ResponseField name="purchase_account" type="Account">
  The [account](https://docs.rootfi.dev/api-reference/bank-accounts/overview) which is associated with the (bill) item that are being purchased
  <Expandable title="properties">
    <Snippet file="accounts_snippets.mdx" />
  </Expandable>
</ResponseField>

<ResponseField name="sales_account" type="Account">
  The [account](https://docs.rootfi.dev/api-reference/bank-accounts/overview) which is associated with the (invoice) item that are being sold
  <Expandable title="properties">
    <Snippet file="accounts_snippets.mdx" />
  </Expandable>
</ResponseField>

<ResponseField name="sales_tax" type="Tax Rate">
  The [tax](https://docs.rootfi.dev/api-reference/tax-rates/overview) which is associated with the (invoice) item that are being sold
  <Expandable title="properties">
    <Snippet file="tax_rates_snippet.mdx" />
  </Expandable>
</ResponseField>

<ResponseField name="purchase_tax" type="Tax Rate">
  The [tax](https://docs.rootfi.dev/api-reference/tax-rates/overview) which is associated with the (bill) item that are being purchased
  <Expandable title="properties">
    <Snippet file="tax_rates_snippet.mdx" />
  </Expandable>
</ResponseField>
