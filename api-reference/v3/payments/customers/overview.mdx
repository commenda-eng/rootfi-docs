...
- Comprehensive customer information: Customer can include associated data like [phone numbers](/docs/phone-number), [addresses](/docs/address), and [external links](/docs/external-link) for a more detailed representation of each customer.
...
| -------------- | ------------------------------------ | --------------------------------------------------------- |
| platform_id    | string                               | The accounting platform's ID for the customer             |
...
| external_links | [External Link](/docs/external-link) | The external links associated with the customer           |
| phone_numbers  | [Phone Number](/docs/phone-number)   | The phone numbers associated with the customer            |
| addresses      | [Address](/docs/address)             | The addresses associated with the customer                |
