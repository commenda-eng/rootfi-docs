...
| deal_probability | string | The deal probability of the pipelines       |
| created_at       | string | The date and time the pipelines was created |
| updated_at       | string | The date and time the pipelines was updated |
