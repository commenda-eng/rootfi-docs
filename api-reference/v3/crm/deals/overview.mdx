...
| amount      | number | The amount of the deal                      |
...
| created_at  | string | The date and time the deal was created      |
| updated_at  | string | The date and time the deal was last updated |
