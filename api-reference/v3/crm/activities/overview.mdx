...
| deal_probability | string | The deal probability of the activity            |
| pipeline_id      | string | The pipeline ID of the activity                 |
| created_at       | string | The date and time the activity was created      |
| updated_at       | string | The date and time the activity was last updated |
