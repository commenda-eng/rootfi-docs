...
| contact_type        | enum   | The type of customer. Value is either CUSTOMER or VENDOR          |
...
| invoices | [Invoices](/api-api-reference/v3/accounting/invoices/overview) | The invoices that belong to this contact |
| bills | [Bills](/api-api-reference/v3/accounting/bills/overview) | The bills that belong to this contact |
| purchase_orders | [Purchase Orders](/api-api-reference/v3/accounting/purchase-orders/overview) | The purchase orders that belong to this contact |
| bank_transactions | [Bank Transactions](/api-api-reference/v3/accounting/bank-transactions/overview) | The bank transactions that belong to this contact |
| sales_orders | [Sales Orders](/api-api-reference/v3/accounting/sales-orders/overview) | The sales orders that belong to this contact |
| invoice_payments | [Invoice Payments](/api-api-reference/v3/accounting/invoice-payments/overview) | The invoice payments that belong to this contact |
| bill_payments | [Bill Payments](/api-api-reference/v3/accounting/bill-payments/overview) | The bill payments that belong to this contact |
| expenses | [Expenses](/api-api-reference/v3/accounting/expenses/overview) | The expenses that belong to this contact |
