...
| document_type     | enum    | The name of the data model with which this document is linked. Currently only these data models are supported: BILLS,INVOICES,EXPENSES                                           |
