...
| sales_orders    | [Sales Order](/api-reference/v3/accounting/sales-orders) | Array of linked Sales Orders associated with this invoice                                             |
...
| addresses | Addresses | The line items associated with the invoice |
| line_items | Line Items | The line items associated with the invoice |
