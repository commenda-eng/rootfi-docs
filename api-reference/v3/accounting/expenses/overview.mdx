...
| contact         | [Contact](/api-reference/v3/accounting/contacts) | The contact to which this expense belongs                            |
| account         | [Account](/api-reference/v3/accounting/accounts) | The account to which this expense belongs                            |
...
| addresses | Addresses | The line items associated with the expense |
