...
<ResponseField name="business_unit_id" type="string">
  The accounting platform’s business / subsidiary id for this journal entry. Conditionally required — mandatory for platforms that support multi-entity accounting (eg. Netsuite).
</ResponseField>
...
| business_unit_id   | string                                               | The accounting platform's ID for business / subsidiary associated with the journal entry |
...
<ResponseExample name="The Journal Entry Object" >

```json The Journal Entry Object
{
  "platform_id": "1234567890123456789",
  "account_id": "1234567890123456789",
  "business_unit_id": "1234567890123456789",
