...
<ResponseField name="file_size" type="float" required>
  The file size of the document in bytes
</ResponseField>

<ResponseField name="document_type_id" type="string" required>
  The platform ID of the document type with which this document is linked to
</ResponseField>

<ResponseField name="document_type" type="Data Model" required>
...
<ResponseField name="download_link" type="string" required>
...
<ResponseField name="document_uploaded" type="boolean" required>
