...
| line_item_type        | enum   | The data model linked to the line item. Values are: `BILLS`, `INVOICES`, `INVOICE_CREDIT_NOTES`, `BILL_CREDIT_NOTES`, `EXPENSES`, `PURCHASE_ORDERS`,`SALES_ORDERS` |
