---
title: "Introduction"
description: Learn how RootFi can help you access your business customers' financial data.
icon: "hand-wave"
---
...
We want RootFi to be your one-stop partner for seamless data connectivity. We will:
...
For example, reading invoice data from an enterprise ERP like Oracle Netsuite will look the same as reading invoice data from an SME focused, on-premsie platform like Tally. Using RootFi, your solution can leverage the same, normalized set of fields, regardless of the underlying platforms.
