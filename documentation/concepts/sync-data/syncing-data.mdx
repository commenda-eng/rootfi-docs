...
Your syncs follow your scopes configuration. We suggest performing a sync only for Data Models you need, to not exhaust the underlying platform's rate limits, save sync time, and limit exposure of sensitive data .
...
The Auto Sync frequency is the rate at which RootFi checks for updates and syncs data with our systems.
