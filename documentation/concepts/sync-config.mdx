...
description: "Configure your sync settings by selecting the data, frequency and level of access from the integration you want to sync with Integration Labs."
icon: "microscope"
---
...
<Note>If you need to sync data more frequently than daily, please reach out to us via chat or email us at contactus@Integration Labs.in</Note>
...
To configure the sync settings at the connection level, you need to pass a `sync_config` object when [creating an invite link](/api-reference/v3/core/invite-links/create-invite-link).
...
You can also update the sync settings of a connection by passing the `sync_config` object when [updating a company](/api-reference/v3/core/companies/edit-company).
