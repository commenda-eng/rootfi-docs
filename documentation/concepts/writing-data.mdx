...
By default our write APIs are synchronous. You can find our APIs in our [Postman Collection](https://postman.rootfi.dev) and our [API Reference](/api-reference/v3/overview/environments).
