...
By default our write APIs are synchronous. You can find our APIs in our [Postman Collection](https://postmanrootfidev) and our [API Reference](/api-reference/accounts/create-accounts).
...
You can view these differences in our [coverage tool](https://coveragerootfidev).
...
You can see these differences in our [coverage tool](https://coveragerootfidev)
