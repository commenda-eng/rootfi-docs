...
Refer to our [Invite Link API](/api-reference/invite-links/create-invite-link) for more details on how to generate Invite Links programmatically. Using the API, you can customize the behavior of the link, such as only displaying platforms that are relevant to your customer and prefilling the customer’s company name.
