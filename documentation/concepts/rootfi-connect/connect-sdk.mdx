...
RootFi supports white labelling the onboarding process through the SDK. Your end users can create connections to their platforms without coming to RootFi dashboard. We currently have only Javascript SDK but you can request us for other frameworks.
