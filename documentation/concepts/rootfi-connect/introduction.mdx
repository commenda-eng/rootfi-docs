...
## Intro to Connect by RootFi

Connect by RootFi streamlines the process of connecting your application to various accounting platforms, providing two efficient methods for integration:
...
<Note>
    **Get Started using Connect SDK**
    ...
    Learn how you can embed onboarding in your application with [Connect by RootFi SDK](/documentation/concepts/rootfi-connect/connect-sdk)
