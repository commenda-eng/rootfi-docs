...
Authorization is a crucial part of Integration Labs - every customer must authorize access to their data before you can pull or push data to their platform. A frictionless and secure authorization flow is essential for accessing your customers' data, which is what Integration Labs offers.

## Intro to Integration Labs Connect

Integration Labs Connect streamlines the process of connecting your application to various accounting platforms, providing two efficient methods for integration:

1. [Invite Link](/documentation/concepts/Integration Labs-connect/invite-link)
2. [Connect SDK](/documentation/concepts/Integration Labs-connect/embedded-sdk)
...
- **Secure:** Integration Labs's Invite Link ensures secure connections with end-to-end encryption and adherence to industry standards.

<Note>
    **Get Started with the Integration Labs Invite Link**

    Learn how you can start onboarding customers with a shareable link using the [Invite Link](/documentation/concepts/Integration Labs-connect/invite-link)

</Note>
  
### Connect SDK: Frontend Integration with Flexibility

The Connect SDK is a software development kit that provides a more customizable, flexible, white-labelled, fully-embedded solution for integrating your customer's platforms into your application, optimized for conversion and building trust. With Integration Labs's Connect SDK, you have full control over the user interface and can tailor the integration process to fit your specific needs.
...
<Note>
    **Get Started using Connect SDK**
    ...
    Learn how you can embed onboarding in your application with [Integration Labs Connect SDK](/documentation/concepts/Integration Labs-connect/connect-sdk)
