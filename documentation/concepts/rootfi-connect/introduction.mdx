...
## Intro to Connect by Integration Labs

Connect by Integration Labs streamlines the process of connecting your application to various accounting platforms, providing two efficient methods for integration:

1. [Invite Link](/documentation/concepts/rootfi-connect/invite-link)
2. [Connect SDK](/documentation/concepts/rootfi-connect/embedded-sdk)
...
<Note>
    **Get Started with the Integration Labs Invite Link**
    ...
    Learn how you can start onboarding customers with a shareable link using the [Invite Link](/documentation/concepts/rootfi-connect/invite-link)
...
<Note>
    **Get Started using Connect SDK**
    ...
    Learn how you can embed onboarding in your application with [Connect by Integration Labs SDK](/documentation/concepts/rootfi-connect/connect-sdk)
