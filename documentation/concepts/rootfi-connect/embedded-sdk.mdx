...
Integration Labs supports white labelling the onboarding process through the Connect SDK. Your end users can create connections to their platforms without using the Integration Labs dashboard to generate [Invite Links](/documentation/concepts/Integration Labs-connect/invite-link). We currently offer a Javascript SDK but you can request other frameworks by contacting us.
...
1. Import the source script in the head tag.
   ...
   Default: `<script src="https://app.Integration Labs.dev/sdk.js"></script>`

   KSA region: `<script src="https://app.sa.Integration Labs.dev/sdk.sa.js"></script>`

2. Load the Integration Labs SDK on page load by calling `RootfiLink.initialize()`.
...
<html>
  <head>
    <script src="https://app.Integration Labs.dev/sdk.js" type="text/javascript"></script>
    <script>
  ...
  <body>
    <p><button onclick="loadRootFi()">Open Integration Labs SDK</button></p>
  </body>
</html>
```
...
import { useRootfiLink } from "Integration Labs-react-sdk";
