...
1. Import the source script in the head tag.
   ...
   Default: `<script src="https://approotfidev/sdk.js"></script>`

   KSA region: `<script src="https://app.sarootfidev/sdk.sa.js"></script>`
...
<html>
  <head>
    <script src="https://approotfidev/sdk.js" type="text/javascript"></script>
    <script>
