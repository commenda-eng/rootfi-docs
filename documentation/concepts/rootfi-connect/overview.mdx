...
1. [Connect Link](/documentation/concepts/rootfi-connect/invite-link)
...
#### Key features of the Connect Link:
...
- **Secure:** RootFi's Connect Link ensures secure connections with end-to-end encryption and adherence to industry standards.
