...
RootFi Connect streamlines the process of connecting your application to various accounting platforms, providing two efficient methods for integration: Connect Link and Connect SDK. These solutions are designed to cater to different use cases and requirements, ensuring seamless integration and data access.

### Connect Link: No-Code User Integrations

The RootFi Connect Link is a no-code solution that enables you to connect your end users to accounting platforms without writing any frontend code. This approach delivers a smooth, in-browser experience and simplifies the integration process for both you and your customers.

#### Key features of the RootFi Connect Link:
...
- **Secure:** The RootFi Connect Link ensures secure connections with end-to-end encryption and adherence to industry standards.

<Note>
    **Get Started with the RootFi Connect Link**

    Learn how you can start onboarding customers with a link you can send them using the [ Connect Link](/documentation/concepts/rootfi-connect/invite-link)
