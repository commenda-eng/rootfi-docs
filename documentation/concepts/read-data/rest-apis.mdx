...
<Note>
    **Highly recommend GraphQL**
    ...
    We highly recommend you [use our GraphQL APIs](/documentation/concepts/read-data/graphql-apis) to read data. Using GrpahQL give you a GUI to easily make complex queries to suit your needs. The GraphQL playground also makes it very easy to test your queries and see the results.
...
Our [API Reference](/api-reference/accounts/get-all-accounts) shows you how to use these parameters. Please contact us if you have any questions.
