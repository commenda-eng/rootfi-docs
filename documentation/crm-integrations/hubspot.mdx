...
4. Go to the ‘Auth’ tab and fill in the following fields:
   - **Redirect URL**: This is the URL where the user will be redirected after they have authorized the app. Use `https://integrate.rootfi.dev/oauth/callback` as the redirect URL.
