...
When your customer is connecting their MSD F&O account to Integration Labs, they will need to enter the client credentials in the F&O dashboard to allow Integration Labs to access the data.
