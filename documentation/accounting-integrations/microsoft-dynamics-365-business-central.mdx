...
### Part 6: Set up the Business Central account to access the data.
...
2. Click on '+New' and enter the client id you copied from the Azure portal, enter a description, change the state to enabled and add 'ADMINISTRATOR' permission in the User Permission Sets. Enter '8f09f705-3d36-4cc9-84c2-8091e362c759' as the client id if you are using Integration Labs credentials.
   ![Client ID MS Dynamics](/images/msdBc/entra_form.png)

### Part 6: Setting up the integration Using Integration Labs Connect

You will need to enter your BC site url in the Integration Labs connect screen.

1. To get the site url, navigate to the BC dashboard and copy the url from the address bar.
   ![Client ID MS Dynamics](/images/msdBc/bcurl.png)
2. In the Integration Labs SDK screen, paste the site url of your BC dashboard.
   ![Client ID MS Dynamics](/images/msdBc/sdk.png)
