...
2. Click on '+New' and enter the client id you copied from the Azure portal, enter a description, change the state to enabled and add `SUPER (DATA)` permission in the User Permission Sets. Enter `8f09f705-3d36-4cc9-84c2-8091e362c759` as the Client ID if you are using Integration Labs credentials.
